...
const resumePath = "/Ishaan-Goswami-Resume.pdf";

export const metadata: Metadata = {
  title: "Resume | Ishaan Goswami",
  description: "Resume of Ishaan Goswami, full-stack engineer and open-source contributor.",
};
      ...
      <section className="relative z-10 ml-0 mr-0 flex min-h-screen flex-col px-4 pb-12 pt-[calc(22vh+112px)] md:ml-[30%] md:mr-[30%]">
        <div className="flex flex-wrap items-center justify-between gap-3 py-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              href={resumePath}
              download="Ishaan-Goswami-Resume.pdf"
