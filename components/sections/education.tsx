...
export function Education() {
  return (
    ...
    >
      <div className="shell">
        <SectionMarker index="04" label="Education" />
          ...
          {education.map((edu, i) => (
            ...
            >
              ...
              <div className="md:col-span-3">
                <p className="font-mono text-[10px] uppercase tracking-ultra-wide tabular text-fg-dim">
                  {edu.period}
                </p>
              </div>
              ...
              <div className="md:col-span-3 md:text-right">
                ...
                <p className="mt-1 font-mono text-[10px] uppercase tracking-ultra-wide text-fg-dim">
                  {edu.location}
                </p>
              </div>
            </motion.div>
