  ...
  return (
    ...
    >
      ...
      <p id="github-activity-summary" className="sr-only">
        Calendar heatmap showing daily GitHub contribution counts for Ishaan2510 over the last year. Scroll horizontally to inspect all weeks.
      </p>
