...
export const projects: Project[] = [
  ...
  },
  {
    ...
    highlights: [
      "Resource-oriented REST API across 4 collections plus auth surface; RBAC via token-based authentication with reusable permission decorators cleanly separating admin and user planes.",
      "Normalized 5-entity relational schema with atomic check-in/check-out state transitions guarding against double-allocation race conditions; Redis cache absorbed concurrent booking load without DB pressure.",
      "Modular async task layer with Celery fanout dispatch for scheduled reporting (daily emails, monthly summaries, CSV exports); decoupled I/O-heavy jobs from the request path.",
    ],
    links: {
      github: "https://github.com/Ishaan2510",
    },
