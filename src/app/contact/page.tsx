  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch(
        "https://formsubmit.co/ajax/ishaangoswami735@gmail.com",
        {
          method: "POST",
          body: data,
        }
          ...
          <div className="flex-shrink-0">
            ...
            <div className="flex flex-wrap gap-1.5">
              <SocialHoverCard socialName="GitHub">
                <a href="https://github.com/Ishaan2510" target="_blank" className="flex items-center gap-1.5 px-2.5 py-1.5 bg-zinc-100 dark:bg-zinc-800/40 hover:bg-zinc-200 dark:hover:bg-zinc-800 rounded-md text-[12px] font-medium text-zinc-600 dark:text-zinc-300 transition-colors border border-zinc-200/50 dark:border-zinc-700/50">
              ...
              <SocialHoverCard socialName="Email">
                <a href="mailto:ishaangoswami735@gmail.com" target="_blank" className="flex items-center gap-1.5 px-2.5 py-1.5 bg-zinc-100 dark:bg-zinc-800/40 hover:bg-zinc-200 dark:hover:bg-zinc-800 rounded-md text-[12px] font-medium text-zinc-600 dark:text-zinc-300 transition-colors border border-zinc-200/50 dark:border-zinc-700/50">
                  <svg viewBox="0 0 24 24" className="w-3.5 h-3.5">
              ...
              <SocialHoverCard socialName="LinkedIn">
                <a href="https://linkedin.com/in/ishaan-goswami-io" target="_blank" className="flex items-center gap-1.5 px-2.5 py-1.5 bg-zinc-100 dark:bg-zinc-800/40 hover:bg-zinc-200 dark:hover:bg-zinc-800 rounded-md text-[12px] font-medium text-zinc-600 dark:text-zinc-300 transition-colors border border-zinc-200/50 dark:border-zinc-700/50">
                  <svg viewBox="0 0 24 24" className="w-3.5 h-3.5">
