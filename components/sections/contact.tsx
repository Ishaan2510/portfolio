...
export function Contact() {
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 bg-gradient-to-b from-bg via-bg/80 to-bg"
        aria-hidden
      />
      ...
      <div className="shell relative">
        ...
        >
          <h2 className="text-balance text-[clamp(2.5rem,8vw,7rem)] font-medium leading-[0.95] tracking-ultra-tight text-fg">
          ...
          {/* Secondary links — minimal rule-divided list */}
              ...
              >
                ...
                >
                  <div className="flex items-baseline gap-6">
                    <span className="font-mono text-[10px] uppercase tracking-ultra-wide text-fg-dim md:w-24">
                      {link.label}
                    </span>
          ...
          {/* Footer */}
          <div className="mt-20 flex flex-col items-start justify-between gap-4 pt-8 font-mono text-[10px] uppercase tracking-ultra-wide text-fg-dim md:mt-28 md:flex-row md:items-center">
            <span>© 2026 Ishaan Goswami</span>
            <span className="tabular">Built with Next.js · Deployed on Vercel</span>
          </div>
        </motion.div>
      </div>
    </section>
